...
def decode_sequence_beam(model, max_len, src_seq, src_mask, src_len, char_dictionary,
                         ...
                         use_gpu=False, beam_size=2,input_word=None,
                         verbose=2):
    ...
    for step, char_decode in enumerate(range(2,  max_len)):
        ...
        #pdb.set_trace()
        beam_id_cand, token_pred_id_cand = get_beam_ind_token_ind(index_pred_candidate, len(model.char_dictionary.instance2index)+1)
        ...
        pdb.set_trace()
        print("!!!!!!!!!! STEP ", step, "pred ", token_pred_id_cand[0, 1, :], "RELATED LOG SCORE ", log_scores_ranked_former_all_seq[0, 1, :, :], " INDEX , ", index_pred_candidate[0,1,:])
