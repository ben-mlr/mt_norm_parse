      ...
      if run_standart:
          ...
          if BERT_NORMALIZE:
              ...
              dir_script, row = script_generation(py_script="train_evaluate_bert_normalizer",
                                                  ...
                                                  norm_2_noise_training_ls=[0., .5],
                                                  gpu_mode="random",
                                                  lr_ls=[0.00001],
                                                  #masking_strategy_ls=[["cls"], None,  ["normed", "0.25"],["normed", "0.5"],
                                                  ...
                                                  overall_report_dir=dir_grid, overall_label=LABEL_GRID,
                                                  train_path=[[LIU_TRAIN_OWOPUTI_LEX_TRAIN]],  dev_path=[[EWT_DEV]],
                                                  ...
                                                  gpus_ls=gpu_ls,
                                                  write_to_dir=RUN_SCRIPTS_DIR, description_comment=description_comment,
                                                  bert_model_ls=["random"], initialize_bpe_layer_ls=[1],
