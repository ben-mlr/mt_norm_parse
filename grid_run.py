      ...
      if run_standart:
          ...
          if NORMALIZE:
              ...
              dir_script, row = script_generation(grid_label=LABEL_GRID, 
                                                  ...
                                                  multi_task_loss_ponderation_ls=[{"pos": 0, "normalize": 1,
          ...
          if FINE_TUNE_BERT:
              ...
              epochs = 200
              lang_iter = ["en_lines", "fr_sequoia"]
              task_to_grid = [["parsing"], ["pos"], ["parsing", "pos"]]
              ...
              dir_script, row = script_generation(py_script="train_evaluate_bert_normalizer",
                                                  ...
                                                  lr_ls=[0.000005],  ## 0.000075,0.000025],
                                                  ...
                                                  tasks_ls=tasks_ls,  #[["pos"], ["normalize", "pos"]],#, ["normalize"]],
          ...
          if PRETRAINING:
              ...
              dir_script, row = script_generation(py_script="train_evaluate_bert_normalizer",
                                                  ...
                                                  freeze_parameters_ls=[0],
                                                  freeze_layer_prefix_ls_ls=[None],
                                                  train_path=[[CODE_MIXED_RAW_CUT_TEST]], dev_path=[[CODE_MIXED_RAW_CUT_TEST]],
                                                  test_paths=[[[CODE_MIXED_RAW_CUT_TEST]]],
                                                  warmup=test_before_run, test_before_run=test_before_run,
                                                  dir_grid=dir_grid, environment=environment, dir_log=log,
                                                  ...
                                                  word_recurrent_cell_encoder_ls=None,
                                                  dropout_word_encoder_cell_ls=None,
                                                  stable_decoding_state_ls=None,
                                                  word_decoding_ls=None, word_embed_ls=None,
                                                  dir_sent_encoder_ls=None,
                                                  dir_word_encoder_ls=None,
                                                  word_embed_init_ls=None, attention_tagging_ls=None,
                                                  char_src_attention_ls=None,
                                                  teacher_force_ls=None,
          ...
          if BERT_NORMALIZATION:
              ...
              dir_script, row = script_generation(py_script="train_evaluate_bert_normalizer",
                                                  ...
                                                  multi_task_loss_ponderation_ls=[OrderedDict([("pos", 0.0), ("normalize", 0.5), ("append_masks", 1.0), ("norm_not_norm", 0), ("edit_prediction", 0), ("parsing", 0)])],
                                                                                  #OrderedDict([("pos", 0.0), ("normalize", 0.5), ("append_masks", 1.0), ("norm_not_norm", 0), ("edit_prediction", 0)]), #OrderedDict([("pos", 0.0), ("normalize", 1.0), ("append_masks", 0.1), ("norm_not_norm", 0), ("edit_prediction", 0)]), #OrderedDict([("pos", 0.0), ("normalize", 1.0), ("append_masks", 1.0), ("norm_not_norm", 0), ("edit_prediction", 0)])],
                                                  dir_grid=dir_grid, environment=environment, dir_log=log,
                                                  epochs=epochs if not (test_before_run or warmup) else WARMUP_N_EPOCHS,
                                                  gpus_ls=gpu_ls,
                                                  write_to_dir=RUN_SCRIPTS_DIR,
