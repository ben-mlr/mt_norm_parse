      ...
      if run_standart:
          ...
          if BERT_NORMALIZE:
              ...
              dir_script, row = script_generation(py_script="train_evaluate_bert_normalizer",
                                                  ...
                                                  #[LIU_TRAIN_OWOPUTI],
                                                  train_path=[[TWEETS_GANESH_1M]], #  [LEX_TRAIN_SPLIT_EN_LINES_TRAIN_500_NOISY],[LEX_TRAIN_SPLIT_EN_LINES_TRAIN_500_2_NOISY], [LEX_TRAIN_SPLIT_EN_LINES_TRAIN_NOISY_1000]],
