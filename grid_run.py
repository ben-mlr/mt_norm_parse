      ...
      if run_standart:
          ...
          if BERT_NORMALIZE:
              ...
              dir_script, row = script_generation(py_script="train_evaluate_bert_normalizer",
                                                  ...
                                                  grid_label=LABEL_GRID,
                                                  batch_size_ls=[1],
                                                  lr_ls=[0.00001],#[OrderedDict([("bert","0.00001"), ("classifier","0.001")]),OrderedDict([("bert","0.00001"), ("classifier","0.0001")]),OrderedDict([("bert","0.00001"), ("classifier","0.00001")])],
                                                  tasks_ls=[["normalize"]],
                                                  fine_tuning_strategy_ls=["standart"],
                                                  dropout_classifier_ls=[0,0.5], dropout_input_bpe_ls=[0.0, 0.2], dropout_bert_ls=[0.1,0.5],
                                                  gold_error_detection_ls=[0], heuristic_ls_ls=[None],
                                                  overall_report_dir=dir_grid, overall_label=LABEL_GRID,
