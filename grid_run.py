      ...
      if run_standart:
          ...
          if BERT_NORMALIZE:
              ...
              dir_script, row = script_generation(py_script="train_evaluate_bert_normalizer",
                                                  ...
                                                  tasks_ls=[["normalize"] for _ in range(2)],#[["pos"], ["normalize", "pos"]],#, ["normalize"]],
                                                  ...
                                                  #[LIU_TRAIN_OWOPUTI],
                                                  train_path=[[LEX_TRAIN_SPLIT_2],[LEX_TRAIN_SPLIT]],#  [LEX_TRAIN_SPLIT_EN_LINES_TRAIN_500_NOISY],[LEX_TRAIN_SPLIT_EN_LINES_TRAIN_500_2_NOISY], [LEX_TRAIN_SPLIT_EN_LINES_TRAIN_NOISY_1000]],
                                                  dev_path=[[LEX_DEV_SPLIT_2],[LEX_DEV_SPLIT]],
                                                  ...
                                                  test_paths=[[[LEX_TRAIN_SPLIT], [LEX_DEV_SPLIT], [LEX_TEST]], [[LEX_TRAIN_SPLIT_2], [LEX_DEV_SPLIT_2], [LEX_TEST]]],
