...
def process_lexnorm2015_data(dir_src, dir_target, log=False):
    ...
    if log:
        ...
        ".format(dir_src=dir_src, dir_target=dir_target, count_tweets=count_tweets,
                 n_tok=n_tok,
                 n_noisy_tok=n_noisy_tok,
                 percent_noisy=n_noisy_tok/n_tok*100,
                 n_cleaned_tok=n_cleaned_tok,
                 percent_clean=n_cleaned_tok/n_tok*100,
                 mean_tweet_len=mean_tweet_len, mean_noisy_tok_per_tweet=mean_noisy_tok_per_tweet,
