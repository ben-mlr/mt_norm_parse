...
ARGUMENT_AVAILABLE_BERT = ["batch_size", "lr", "initialize_bpe_layer", "freeze_parameters",  "freeze_layer_prefix_ls",
                           ...
                           "checkpoint_dir", "norm_2_noise_training", "bert_module",
                           "tasks", "masking_strategy",# "portion_mask",
                           "heuristic_ls", "gold_error_detection", "dropout_bert", "aggregating_bert_layer_mode", "layer_wise_attention", "tokenize_and_bpe"]
