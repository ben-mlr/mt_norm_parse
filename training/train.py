...
def run_epoch(data_iter, model, loss_compute, verbose=0):
    ...
    for i, batch in enumerate(data_iter):
        ...
        if i % 10 == 1:
            ...
            print("Epoch Step: {}  Loss: {}  Tokens per Sec: {}  ".format(i, loss / batch.ntokens.type(torch.FloatTensor), tokens / elapsed))
            start = time.time()
            tokens = 0
