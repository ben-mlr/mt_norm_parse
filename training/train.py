...
def run_epoch(data_iter, model, loss_compute, verbose=0, i_epoch=None,
              n_epochs=None, n_batches=None, empty_run=False, log_every_x_batch=VERBOSE_1_LOG_EVERY_x_BATCH):
    "Standard Training and Logging Function"
    start = time.time()
    total_tokens = 0
    total_loss = 0
    tokens = 0
    printing("Starting {} epoch out of {} ".format(i_epoch, n_epochs), verbose, verbose_level=1)
